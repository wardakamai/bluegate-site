...
export const instruments: Instrument[] = [
  { symbol: 'BZ=F', name: 'Brent Crude',  sourceCode: 'ICE Brent Futures (BZ=F)',     unit: 'per barrel'  },
  { symbol: 'CL=F', name: 'WTI Crude',    sourceCode: 'NYMEX WTI Futures (CL=F)',     unit: 'per barrel'  },
  { symbol: 'HO=F', name: 'Gasoil / Heating Oil', sourceCode: 'NYMEX Heating Oil (HO=F)', unit: 'per gallon' },
...
- Disclaimer paragraph (smaller, muted): *"Indicative only. Not a firm offer. Storage tariffs are quoted on a per-m³/month basis with throughput rebates, linked to Platts Rotterdam Barges, Argus NWE, or agreed differentials. For binding pricing contact our trading desk."*
