...
const ROUTES: Route[] = [
  ...
  { path: 'services/oil-storage',        priority: 0.85, changeFrequency: 'monthly' },
  { path: 'services/product-inspection', priority: 0.8,  changeFrequency: 'monthly' },
  { path: 'services/laboratory',         priority: 0.8,  changeFrequency: 'monthly' },
  { path: 'services/shipping',           priority: 0.8,  changeFrequency: 'monthly' },
  { path: 'terminal',                    priority: 0.85, changeFrequency: 'monthly' },
  { path: 'storage-facility',            priority: 0.85, changeFrequency: 'monthly' },
  { path: 'markets',                     priority: 0.75, changeFrequency: 'daily'   },
  ...
  { path: 'hse',                         priority: 0.75, changeFrequency: 'monthly' },
