...
export const metadata: Metadata = pageMeta({
  ...
  description: 'Terms and conditions for Blue Gate Shipping and Trade B.V., Rotterdam oil tank farm and storage terminal operator.',
  path: 'terms',
})
    ...
    <main className="bg-page min-h-screen">
      <div className="mx-auto max-w-3xl px-6 py-20 md:py-28">
        ...
        <div className="space-y-4 font-sans text-sm text-muted-foreground leading-relaxed">
          ...
          <p>
            Full terms and conditions are pending client review and legal sign-off.
            Please contact <a href="mailto:storage@bluegou.com" className="text-brand hover:underline">storage@bluegou.com</a> with any enquiries.
          </p>
        </div>
      </div>
    </main>
