...
export const metadata: Metadata = pageMeta({
  ...
  description: 'Privacy policy for Blue Gate Shipping and Trade B.V., Rotterdam oil tank farm and storage terminal operator.',
  path: 'privacy',
})
    ...
    <main className="bg-page min-h-screen">
      <div className="mx-auto max-w-3xl px-6 py-20 md:py-28">
        ...
        <div className="space-y-4 font-sans text-sm text-muted-foreground leading-relaxed">
          ...
          <p>
            Full privacy policy text is pending client review and legal sign-off.
            Please contact <a href="mailto:storage@bluegou.com" className="text-brand hover:underline">storage@bluegou.com</a> with any data protection enquiries.
          </p>
        </div>
      </div>
    </main>
