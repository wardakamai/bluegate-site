...
export const products: Product[] = [
  {
    ...
    specifications: [
      ...
      {
        property: 'Distillation 10% recovered',
        value: '≤205°C; FBP ≤300°C',
        method: 'ASTM D86',
      },
      {
        property: 'Sulphur',
        value: '≤0.30% m/m (≤10 ppm ULS option)',
        method: 'ASTM D1266',
      },
      { property: 'Aromatics', value: '≤25% v/v', method: 'ASTM D1319' },
    ],
    matchingStorage: {
      tankType: 'Fixed-roof tank (stainless or epoxy-lined)',
...

  {
    ...
    specifications: [
      ...
      {
        property: 'FAME content',
        value: '≤7% v/v (B7) or 0% (B0)',
        method: 'EN 14078',
      },
    ],
    matchingStorage: {
      ...
      features: [
        ...
        'Dedicated ULSD segregation to prevent cross-contamination',
        'Heated trace lines for winter-grade product',
      ],
    },
    origins:
...

  {
    ...
    handlingSafety: {
      unNumber: 'UN 3082 / UN 1993 (flash-dependent)',
      class: '3',
      packingGroup: 'III',
...

  {
    ...
    matchingStorage: {
      tankType: 'Floating-roof tank with vapour recovery system',
