            ...
            <ScrollReveal key={article.date} delay={i * 0.1} className="h-full">
              <GlowCard className="bg-bg flex h-full flex-col rounded-xl p-7">
                <time
                  ...
                  className="text-muted-foreground mb-4 block font-mono text-[11px]"
                >
                ...
                <Link
                  href={article.href}
                  className="text-ink hover:text-brand mt-auto font-sans text-sm font-medium transition-colors"
