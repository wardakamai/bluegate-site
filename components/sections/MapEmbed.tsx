export function MapEmbed() {
  return (
    <div className="border-border-soft overflow-hidden rounded-xl border">
      ...
      />
      <div className="bg-bg border-border-soft flex items-center justify-between border-t px-5 py-3">
        ...
        <a
          ...
          className="text-brand hover:text-brand-steel font-sans text-xs transition-colors"
        >
          Open in Google Maps →
        </a>
      </div>
