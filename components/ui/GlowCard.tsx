...
export function GlowCard({ children, className, tilt = 6 }: GlowCardProps) {
  ...
  return (
    <div
      ...
      className={cn('preserve-3d relative overflow-hidden will-change-transform', className)}
    ...
    >
      ...
      <div
        ref={glowRef}
        aria-hidden="true"
        className="pointer-events-none absolute top-0 left-0 h-60 w-60 rounded-full opacity-0"
        style={{
