...
export function organizationSchema(): JsonLd {
  return {
    ...
    identifier: [
      ...
      { '@type': 'PropertyValue', name: 'SAFE', value: site.legal.safe },
    ],
    sameAs: [
  ...
  return {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'For petroleum storage enquiries at our Fujairah terminal, contact us at storage@bluegou.com or call +31 97005034730. Our Fujairah operations provide crude oil and refined product storage outside the Strait of Hormuz.',
        },
      },
      {
        '@type': 'Question',
